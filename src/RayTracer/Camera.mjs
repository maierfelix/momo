...
Camera.prototype.transform = function() {
  ...
  let translation = vec3.fromValues(0, -22.0, distance.z);
...
Camera.prototype.update = function() {
  ...
  // lightCount
  // -1, since the light at 0 is a fake light
  // to satisfy minimum buffer requirements
  uint32View[37] = parent.lights.length;
